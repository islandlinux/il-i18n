define(['sprintf', 'i18next', 'i18next-xhr-backend'], function (vsprintf, i18next, i18nextXHRBackend) { 'use strict';
     ...
     * I18nClient
     *
     * @version x.x.x #4 Add values to client
     *          x.x.x #3 Implement promises
